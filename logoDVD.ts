export default function logoDVD () {
    const colors = ["red", "green", "blue", "yellow", "purple", "orange"];
    const width = window.innerWidth * 0.123;
    const height = (window.innerWidth * 0.123) / 2;
    ...
    function update(ctx: CanvasRenderingContext2D) {
        ...
        whenColideBorder.call(this, ctx, false);
        whenColideBorder.call(this, ctx, true);
    }
